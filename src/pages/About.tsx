...
export default function About() {
  return (
    <>
      <SEO title="About Us | TechZone" description="Learn the story behind TechZone — Pakistan's premier tech accessories destination." />
      <div className="container-x py-6">
        <Breadcrumbs items={[{ label: "Home", to: "/" }, { label: "About" }]} />
        <div className="mt-6 rounded-xl bg-gradient-to-br from-primary/20 to-card border border-border p-8 md:p-14">
          <h1 className="font-display text-3xl md:text-5xl font-bold">About TechZone</h1>
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">From our humble beginnings in 2018, TechZone quickly grew to become one of Pakistan's premier tech accessories e-commerce destinations. We started with a simple mission: bring authentic, well-priced tech gear to every doorstep in Pakistan, backed by responsive support that actually listens.</p>
